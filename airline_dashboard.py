...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 17 10:52:13 2021
                                    ...
                                    html.Div([
                                        ...
                                        dcc.Dropdown(id='input-type',
                                                     ...
                                                     style={'width': '80%', 
                                                            'padding': '3px',
                                                            'font-size': '20px',
                                                            'text-align-last': 'center'})], style={'display': 'flex'}
                                        ),                                    
                                    html.Div([
                                        html.Div(
                                            [
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
    ...
    if chart == 'OPT1':
        bar_data, line_data, div_data, map_data, tree_data = compute_data_choice(df)
        ...
        carrier_fig = px.line(avg_car, x='Month', y='CarrierDelay', color='Reporting_Airline',
                              title="Average carrier delay time (minuted) by airline")
